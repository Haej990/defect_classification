...
CFG = {
    ...
    'LEARNING_RATE':3e-4, # When using SGD, use 10-100x higher learning rate 
    'BATCH_SIZE':64, 
    'SEED':41 
}
...
#Run
    ...
    optimizer = torch.optim.AdamW(params = model.parameters(), lr = CFG["LEARNING_RATE"]) # Adam / AdamW / SGD
